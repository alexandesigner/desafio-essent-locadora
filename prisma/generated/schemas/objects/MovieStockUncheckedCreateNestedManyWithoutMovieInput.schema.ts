...
const Schema: z.ZodType<Prisma.MovieStockUncheckedCreateNestedManyWithoutMovieInput> =
  z
    .object({
      create: z
        .union([
...
export const MovieStockUncheckedCreateNestedManyWithoutMovieInputObjectSchema =
  Schema;
