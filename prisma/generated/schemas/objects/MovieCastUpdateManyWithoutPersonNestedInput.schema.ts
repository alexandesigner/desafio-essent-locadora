...
const Schema: z.ZodType<Prisma.MovieCastUpdateManyWithoutPersonNestedInput> = z
  .object({
    create: z
      .union([
...
export const MovieCastUpdateManyWithoutPersonNestedInputObjectSchema = Schema;
