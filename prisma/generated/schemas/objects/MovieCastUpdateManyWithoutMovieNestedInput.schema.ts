...
const Schema: z.ZodType<Prisma.MovieCastUpdateManyWithoutMovieNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => MovieCastUpdateManyWithWhereWithoutMovieInputObjectSchema),
        z
          .lazy(() => MovieCastUpdateManyWithWhereWithoutMovieInputObjectSchema)
          .array()
      ])
      .optional(),
    deleteMany: z
...
export const MovieCastUpdateManyWithoutMovieNestedInputObjectSchema = Schema;
