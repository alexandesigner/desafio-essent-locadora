...
const Schema: z.ZodType<Prisma.RentalUncheckedCreateWithoutMovie_stockInput> = z
  .object({
...
export const RentalUncheckedCreateWithoutMovie_stockInputObjectSchema = Schema;
