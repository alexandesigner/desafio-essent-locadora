...
const Schema: z.ZodType<Prisma.RentalUncheckedUpdateManyWithoutMovie_stockNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const RentalUncheckedUpdateManyWithoutMovie_stockNestedInputObjectSchema =
  Schema;
