...
const Schema: z.ZodType<Prisma.MovieUncheckedCreateNestedManyWithoutCategoryInput> =
  z
    .object({
      create: z
        .union([
...
export const MovieUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
