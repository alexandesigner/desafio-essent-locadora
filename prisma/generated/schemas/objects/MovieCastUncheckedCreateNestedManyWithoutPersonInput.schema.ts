...
const Schema: z.ZodType<Prisma.MovieCastUncheckedCreateNestedManyWithoutPersonInput> =
  z
    .object({
      create: z
        .union([
...
export const MovieCastUncheckedCreateNestedManyWithoutPersonInputObjectSchema =
  Schema;
