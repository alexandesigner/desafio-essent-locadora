...
const Schema: z.ZodType<Prisma.MovieUpdateManyWithoutCategoryNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => MovieUpdateManyWithWhereWithoutCategoryInputObjectSchema),
        z
          .lazy(() => MovieUpdateManyWithWhereWithoutCategoryInputObjectSchema)
          .array()
      ])
      .optional(),
    deleteMany: z
...
export const MovieUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
