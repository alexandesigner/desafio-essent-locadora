...
const Schema: z.ZodType<Prisma.RentalUncheckedUpdateManyWithoutRentalsInput> = z
  .object({
    id: z
      .union([
        z.number(),
...
export const RentalUncheckedUpdateManyWithoutRentalsInputObjectSchema = Schema;
