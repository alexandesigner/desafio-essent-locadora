...
const Schema: z.ZodType<Prisma.MovieStockUpdateManyWithoutMovieNestedInput> = z
  .object({
    create: z
      .union([
...
export const MovieStockUpdateManyWithoutMovieNestedInputObjectSchema = Schema;
