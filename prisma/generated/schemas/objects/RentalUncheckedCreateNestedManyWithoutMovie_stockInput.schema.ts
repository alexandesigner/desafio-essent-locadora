...
const Schema: z.ZodType<Prisma.RentalUncheckedCreateNestedManyWithoutMovie_stockInput> =
  z
    .object({
      create: z
        .union([
...
export const RentalUncheckedCreateNestedManyWithoutMovie_stockInputObjectSchema =
  Schema;
