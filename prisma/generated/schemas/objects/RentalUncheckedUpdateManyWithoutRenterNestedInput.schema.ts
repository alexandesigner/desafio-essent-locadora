...
const Schema: z.ZodType<Prisma.RentalUncheckedUpdateManyWithoutRenterNestedInput> =
  z
    .object({
      create: z
        .union([
      ...
      upsert: z
        .union([
          z.lazy(
            () => RentalUpsertWithWhereUniqueWithoutRenterInputObjectSchema
          ),
          z
            .lazy(
              () => RentalUpsertWithWhereUniqueWithoutRenterInputObjectSchema
      ...
      update: z
        .union([
          z.lazy(
            () => RentalUpdateWithWhereUniqueWithoutRenterInputObjectSchema
          ),
          z
            .lazy(
              () => RentalUpdateWithWhereUniqueWithoutRenterInputObjectSchema
...
export const RentalUncheckedUpdateManyWithoutRenterNestedInputObjectSchema =
  Schema;
