...
const Schema: z.ZodType<Prisma.RentalUncheckedCreateNestedManyWithoutRenterInput> =
  z
    .object({
      create: z
        .union([
...
export const RentalUncheckedCreateNestedManyWithoutRenterInputObjectSchema =
  Schema;
